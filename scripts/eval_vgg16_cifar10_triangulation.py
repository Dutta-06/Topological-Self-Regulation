"""Evaluation and Triangulation Summary for VGG-16-BN on CIFAR-10 Benchmark."""
...
def main():
    ...
    print("Evaluating Arm 1: Standard Static Reference Baseline (VGG-16-BN)...")
    ck1 = torch.load("results/reference/vgg16bn_cifar10.pt", map_location="cpu", weights_only=False)
    m1 = build_model("vgg16_bn", 10).to(device)
    ...
    print("Evaluating Arm 3: C2 Static Matched Control (VGG-16-BN)...")
    ck3 = torch.load("results/static_matched/vgg16bn_cifar10_two_regime.pt", map_location="cpu", weights_only=False)
    ck2_raw = torch.load("results/tsrx/vgg16bn_cifar10_two_regime.pt", map_location="cpu", weights_only=False)
    widths = ck2_raw["discovered_widths"]
    m3 = build_model("vgg16_bn", 10)
    ...
    print("Evaluating Arm 2: TSR-X Dynamic Plasticity (VGG-16-BN)...")
    ck2 = ck2_raw
    m2 = build_model("vgg16_bn", 10)
    ...
    print("\n" + "="*95)
    print("  VGG-16-BN CIFAR-10 RIGOROUS 3-WAY TRIANGULATION BENCHMARK RESULTS")
    print("="*95)
    ...
    torch.save(summary_data, "results/vgg16bn_cifar10_triangulation_summary.pt")
    print("Summary saved to results/vgg16bn_cifar10_triangulation_summary.pt")
