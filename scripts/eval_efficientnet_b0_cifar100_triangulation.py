"""Evaluation and Triangulation Summary for EfficientNet-B0 on CIFAR-100 Benchmark."""
...
def main():
    ...
    print("Evaluating Arm 1: Standard Static Reference Baseline (EfficientNet-B0 CIFAR-100)...")
    ck1 = torch.load("results/reference/efficientnet_b0_cifar100.pt", map_location="cpu", weights_only=False)
    m1 = build_model("efficientnet_b0", 100, cifar_stem=True).to(device)
    ...
    print("Evaluating Arm 3: C2 Static Matched Control (EfficientNet-B0 CIFAR-100)...")
    ck3 = torch.load("results/static_matched/efficientnet_b0_cifar100_two_regime.pt", map_location="cpu", weights_only=False)
    ck2_raw = torch.load("results/tsrx/efficientnet_b0_cifar100_two_regime.pt", map_location="cpu", weights_only=False)
    widths = ck2_raw["discovered_widths"]
    m3 = build_model("efficientnet_b0", 100, cifar_stem=True)
    ...
    print("Evaluating Arm 2: TSR-X Dynamic Plasticity (EfficientNet-B0 CIFAR-100)...")
    ck2 = ck2_raw
    m2 = build_model("efficientnet_b0", 100, cifar_stem=True)
    ...
    print("\n" + "="*85)
    print("      EFFICIENTNET-B0 CIFAR-100 3-WAY TRIANGULATION BENCHMARK SUMMARY")
    print("="*85)
    ...
    out_path = Path("results/efficientnet_b0_cifar100_triangulation_summary.pt")
